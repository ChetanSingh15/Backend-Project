...
const getUserChannelSubscribers = asyncHandler(async (req,res) => {
    ...
    // channelId =   new mongoose.Types.ObjectId(channelId); // Don't know why it is here
...
const getSubscribedChannels = asyncHandler(async (req,res) => {
    ...
    return res
    .stats(200)
    .json(new ApiResponse(200,subscribedChannels,"Subscribed Channels feteched successfully"));
})
